...
export default function OrderList() {
    ...
    useEffect (() => {
        ...
        async function getOrders() {
            const response = await fetch(`https://proyectoinstayabackend-production.up.railway.app/api/orders/orders/`);
    ...
    async function deleteOrder(id) {
        await fetch(`https://proyectoinstayabackend-production.up.railway.app/api/orders/${id}`, {
            method: "DELETE"
        });
