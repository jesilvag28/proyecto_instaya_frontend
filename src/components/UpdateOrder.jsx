...
export default function UpdateOrder() {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            ...
            const response = await fetch(`https://proyectoinstayabackend-production.up.railway.app/api/orders/orders/${params.id.toString()}`);  
    ...
    async function handleSubmit(e) {
        ...
        await fetch(`https://proyectoinstayabackend-production.up.railway.app/api/orders/update-order/${params.id}`, {
            method: "PUT",
